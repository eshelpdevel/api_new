...
$idName = isset($_GET['idName']) ? $_GET['idName'] : ""; //UPDATE_FROM_CRM 
$agrmntid = isset($_GET['agrmntid']) ? $_GET['agrmntid'] : ""; // Default or error handling needed
$distributedDate = isset($_GET['distributedDate']) ? $_GET['distributedDate'] : ""; // Default or error handling needed
$no_pengajuan = isset($_GET['no_pengajuan']) ? $_GET['no_pengajuan'] : ""; // Default or error handling needed
